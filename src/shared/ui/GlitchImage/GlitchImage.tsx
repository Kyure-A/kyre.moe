...
const GlitchImage = ({ 
    ...
    const getRandomClipPath = (): string => {
        ...
        for (let i = 0; i <= segments; i++) {
            ...
            points.push(`${(i / segments) * 100 + xOffset}% ${Math.random() * 100 + yOffset}%`);
        }
    ...
    const originalOpacity = isGlitching && glitchType === 3 ? 
                            (Math.random() > 0.7 ? '0.7' : '1') : '1';
          ...
          {isGlitching && (
              ...
              <div 
                  ...
                  style={{ 
                      ...
                      filter: 'brightness(1.5) contrast(1.3) hue-rotate(0deg) saturate(1.5)', 
              ...
              <div 
                  ...
                  style={{ 
                      opacity: 0.7, // Higher opacity
                      filter: 'brightness(1.5) contrast(1.3) hue-rotate(240deg) saturate(1.5)', 
              ...
              {(glitchType === 2 || glitchType === 3) && glitchBlocks.map((block, index) => (
                  <div
                      key={index}
              ...
              {Array.from({ length: Math.floor(3 + normalizedIntensity * 7) }).map((_, index) => {
                  const top = Math.random() * 100;
